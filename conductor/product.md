...
## Core Features
- **Interactive Keyboard Navigation:** Effortless directory traversal using arrow keys, enabling users to expand, collapse, and enter directories with minimal keystrokes.
